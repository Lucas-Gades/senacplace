...
export class ProdutoService {
  ...
  listaProdutos: Produto[] = [
    ...
    categoria: 'Esportes',
    condicao: 'Usado',
    descricao: 'Bicicleta em bom estado, ideal para trilhas.',
    preco: 1200,
    fotos: ['https://example.com/bike1.jpg'],
  ...
  },
  {
    ...
    condicao: 'Novo',
    descricao: 'Smartphone com câmera de alta resolução e bateria duradoura.',
    preco: 2500,
    fotos: ['https://example.com/phone1.jpg'],
    contato: '(51) 99876-5432',
    cidade: 'Gravataí',
    dataPublicacao: new Date('2024-02-20')
  },
  {
    id: 3,
    usuarioId: 3,
    titulo: 'Livro "Aprendendo Angular"',
    categoria: 'Livros',
    condicao: 'Usado',
    descricao: 'Livro didático sobre desenvolvimento web com Angular.',
    preco: 80,
    fotos: ['https://example.com/book1.jpg'],
  ...
  },
  {
    ...
    categoria: 'Calçados',
    condicao: 'Novo',
    descricao: 'Tênis confortável para corrida e academia.',
    preco: 350,
    fotos: ['https://example.com/tenis1.jpg'],
    contato: '(51) 91234-5678',
    cidade: 'Porto Alegre',
    dataPublicacao: new Date('2024-04-01')
  },
  {
    id: 5,
    usuarioId: 1,
    ...
    categoria: 'Roupas',
    condicao: 'Usado',
    descricao: 'Camiseta em ótimo estado, tamanho M.',
    preco: 45,
    fotos: ['https://example.com/camiseta1.jpg'],
    contato: '(51) 91234-5678',
    cidade: 'Gravataí',
    dataPublicacao: new Date('2024-04-05')
  },
  {
    id: 6,
    usuarioId: 1,
    ...
    categoria: 'Móveis',
    condicao: 'Usado',
    descricao: 'Mesa em madeira com gavetas, perfeita para home office.',
    preco: 280,
    fotos: ['https://example.com/mesa1.jpg'],
    contato: '(51) 91234-5678',
    cidade: 'Alvorada',
